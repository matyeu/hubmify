...
export default function CollapseButton() {
  ...
  return (
    <button
      onClick={toggleCollapse}
      className={`absolute -right-4 z-[100] w-8 h-8 flex items-center justify-center bg-white border border-gray-200 rounded shadow-lg hover:bg-gray-50 transition-all cursor-pointer ${
