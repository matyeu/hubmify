...
export default function Button({
  ...
  const baseClasses = hasVariant
    ? "inline-flex items-center justify-center gap-2 font-medium rounded-xl transition-all duration-200 cursor-pointer disabled:opacity-50 disabled:cursor-default"
    : "";
